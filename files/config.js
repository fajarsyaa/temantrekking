...
const SITE = {
  ...
  /* ──────────────────────────────────────────────────────────────────
   *  HERO — headline utama + foto latar full-bleed
   *  Ganti backgroundImage dengan URL foto online lain kapan saja.
   * ────────────────────────────────────────────────────────────────── */
  hero: {
    backgroundImage:
      "https://commons.wikimedia.org/wiki/Special:FilePath/Bromo-Tengger-Semeru-National-Park_Indonesia_Sunrise-over-the-caldera-02.jpg",
    heading: "Naik turun",
    headingAccent: "bukan cuma jalan.",
    swipeLabel: "Geser, lihat trip",
  },
   ...
   *    - image       → URL foto trip (dipakai di kartu trip, hero, & CTA)
  ...
  trips: [
    /* ─── TRIP 1 : GUNUNG AGUNG ─────────────────────────────────────── */
    {
      ...
      name: "Gunung Agung",
      image:
        "https://commons.wikimedia.org/wiki/Special:FilePath/Kawah_Gunung_Agung.jpg",
    ...
    /* ─── TRIP 2 : GUNUNG RAUNG ─────────────────────────────────────── */
    {
      ...
      name: "Gunung Raung",
      image:
        "https://commons.wikimedia.org/wiki/Special:FilePath/Gunung_Raung_dilihat_dari_Gunung_Ijen.jpg",
      route: "via Kalibaru",
    ...
    /* ─── TRIP 3 : GUNUNG ARJUNO ─────────────────────────────────────── */
    {
      ...
      name: "Gunung Arjuno",
      image:
        "https://commons.wikimedia.org/wiki/Special:FilePath/Gunung_Arjuno_di_Pagi_Hari_-_1.jpg",
      route: "via Tretes",
